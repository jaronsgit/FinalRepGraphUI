        ...
        return (
            <Paper style={styles.Paper} variant="elevation" elevation={5}>
                <Grid container direction="column" justify="space-between" alignItems="center" style={{width: "100%"}}>
                            ...
                            <Paper style={styles.SentencePaper}>
                                <List component="ul">
                                    {parsedSentences.map((sentence) =>
                                        <Tooltip key={sentence.id} TransitionComponent={Zoom} title="Display Graph >"
                                                 placement="right">
                                            <div>
                                                <ListItem button onClick={() => onSelect(sentence.id)}>
                                                    <ListItemText
                    ...
                    <Grid item style={{width: "100%"}}>
                        <AnalysisAccordion
                            sentence={this.props.sentence} sentences={this.props.sentences}
                            onClickSubset={this.props.subsetHandleToggle}
                            handleSearchNodeSet={this.props.handleSearchNodeSet}
                            handleCompareTwoGraphs={this.props.handleCompareTwoGraphs}
                            handleFormalTests={this.props.handleFormalTests}
                            handleDisplaySubset={this.props.handleDisplaySubset}
                        />
                    </Grid>
                </Grid>
            </Paper>
    ...
    return (
        <div className={classes.root}>
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>Select a node on the graph displayed in the visualization area to see the corresponding
                        subset of the graph:</Typography>
                </AccordionDetails>
                <DisplaySubsetTool onClick={props.onClickSubset} handleDisplaySubset={props.handleDisplaySubset}/>
            </Accordion>
            <Accordion>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon/>}
                ...
                <AccordionDetails>
                    <Typography>Manually select a number of node labels to search against the uploaded
                        data-set:</Typography>
                </AccordionDetails>
                <SearchSubgraphPatternTool sentence={props.sentence} onClick={props.onClickSubset}
                                           handleSearchNodeSet={props.handleSearchNodeSet}/>
            </Accordion>
            <Accordion>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon/>}
                ...
                <CompareTwoGraphsTool sentences={props.sentences} handleCompareTwoGraphs={props.handleCompareTwoGraphs}/>
            </Accordion>
            <Accordion>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon/>}
                ...
                <AccordionDetails>
                    <Typography>Select a number of graph properties with which to test the currently displayed
                        graph:</Typography>
                </AccordionDetails>
                <FormalTestsTool handleFormalTests={props.handleFormalTests}/>
            </Accordion>
